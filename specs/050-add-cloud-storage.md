...
- Create a new additional implementation of EventStorer that uses Google Cloud
  Storage
- Use the google.com/go/storage Go package 
- Hard code the bucket name `drawexact-telemetry'
- Change the event storer used in the dependencies for the cloud function with th
  new one. 
